...
fn main() {
    ...
    let x_squeeze : SPNGOutput=x_sponge.squeeze_native_field_elements(1);
    let conv1_squeeze : SPNGOutput=conv1_sponge.squeeze_native_field_elements(1);
    let conv2_squeeze : SPNGOutput=conv2_sponge.squeeze_native_field_elements(1);
    let conv3_squeeze : SPNGOutput=conv3_sponge.squeeze_native_field_elements(1);
    let fc1_squeeze : SPNGOutput=fc1_sponge.squeeze_native_field_elements(1);
    let fc2_squeeze : SPNGOutput=fc2_sponge.squeeze_native_field_elements(1);
    let z_squeeze : SPNGOutput=z_sponge.squeeze_native_field_elements(1);
