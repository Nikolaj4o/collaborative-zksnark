...
#[derive(Clone)]
pub struct SPNGCircuit<F: PrimeField> {
	pub param: SPNGParam<F>,
	pub input: SPNGInput,
	pub output: SPNGOutput<F>
}


impl <F: PrimeField>ConstraintSynthesizer<F> for SPNGCircuit<F>{
...
fn spng_circuit_helper<F: PrimeField>(
    input: SPNGInput ,
	output: &SPNGOutput<F>,
